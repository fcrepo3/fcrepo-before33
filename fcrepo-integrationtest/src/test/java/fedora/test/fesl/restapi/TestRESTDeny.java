...
{
	private final static Logger log = Logger.getLogger(TestRESTDeny.class);
	...
	public void setup()
	{
		...
		try
		{
			if (log.isDebugEnabled())
				log.debug("Initialising HttpUtils...");
	...
	public void testFindObjectsXML02()
	{
		...
		try
		{
			String url = "objects?terms=*Helicopter&resultFormat=xml&pid=true"
	...
	public void testGetObjectHistory()
	{
		...
		try
		{
			...
			boolean check = response.contains("<font size=\"+1\">test:1000003</font>");
			Assert.assertTrue("Expected object data not found", check);
		}
		catch (AuthorizationDeniedException ade)
		{
	...
	public void testAddDatastream()
	{
		...
		try
		{
			...
			String url = "objects/test:1000001/datastreams/TESTAD?dsLabel=TESTAD";
	...
	public void testModifyDatastream()
	{
		...
		try
		{
			...
			// Add test datastream
			String url = "objects/test:1000000/datastreams/TESTAD?dsLabel=TESTAD";
			String response = httpUtils.post(url, null, data);
			if (log.isDebugEnabled())
				log.debug("http response:\n" + response);
	...
	public void testModifyObject()
	{
		...
		{
			// modify the object.
			String url = "objects/test:1000000?label=This+is+a+New+Label&state=I";
	...
	public void testSetDatastreamState()
	{
		...
		try
		{
			...
			// Add test datastream
			String url = "objects/test:1000000/datastreams/TESTDS?dsLabel=TESTDS";
			String response = httpUtils.post(url, null, data);
			if (log.isDebugEnabled())
				log.debug("http response:\n" + response);
