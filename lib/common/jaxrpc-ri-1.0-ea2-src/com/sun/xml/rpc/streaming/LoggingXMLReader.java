...
// Source File Name:   LoggingXMLReader.java
...
//            XMLReader, XMLReaderUtil, Attributes
...
public class LoggingXMLReader
    ...
    public int nextContent() {
        ...
        log.println("Next content state: " + XMLReaderUtil.getStateName(reader));
        return nextState;
    }

    public int nextElementContent() {
        int nextState = reader.nextElementContent();
        log.println("Next element content state: " + XMLReaderUtil.getStateName(reader));
        return nextState;
    }
