...
class WSDLDocument$GloballyValidatingAction
    implements EntityAction, EntityReferenceAction {

    private ValidationException _exception;
    private AbstractDocument _document;
    private EntityReferenceValidator _validator;
    private final WSDLDocument this$0; /* synthetic field */

    public WSDLDocument$GloballyValidatingAction(WSDLDocument this$0, AbstractDocument document, EntityReferenceValidator validator) {
        this.this$0 = this$0;
        _document = document;
