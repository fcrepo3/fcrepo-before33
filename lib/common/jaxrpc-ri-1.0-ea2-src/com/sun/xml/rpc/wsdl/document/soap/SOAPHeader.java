...
// Source File Name:   SOAPHeader.java
...
//            SOAPHeaderFault, SOAPConstants, SOAPUse
...
public class SOAPHeader extends Extension {
    ...
    public void accept(ExtensionVisitor visitor) throws Exception {
        ...
        for(Iterator iter = _faults.iterator(); iter.hasNext(); ((SOAPHeaderFault)iter.next()).accept(visitor));
