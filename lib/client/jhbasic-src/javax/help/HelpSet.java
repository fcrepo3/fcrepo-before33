/*
 * @(#) HelpSet.java 1.91 - last change made 04/20/01
 *
...
public class HelpSet {
    ...
    public Map getCombinedMap() {
 	if (combinedMap == null) {
		...
		combinedMap.add(hs.getLocalMap());
	    }
	}
	return combinedMap;
    }
    ...
    private ClassLoader loader;	// encapsulates loading...
