...
public class DOValidatorXMLSchemaTest
    ...
    public void testFoxmlValidation() throws Exception {
        ...
        DOValidatorXMLSchema dov =
                new DOValidatorXMLSchema("repository/src/main/resources/xsd/foxml1-1.xsd");
        dov.validate(in);
    }
    ...
    public void testMetsValidation() throws Exception {
        ...
        DOValidatorXMLSchema dov =
                new DOValidatorXMLSchema("repository/src/main/resources/xsd/mets-fedora-ext1-1.xsd");
        dov.validate(in);
    }
    ...
    public void testAtomValidation() throws Exception {
        ...
        DOValidatorXMLSchema dov = new DOValidatorXMLSchema("repository/src/main/resources/xsd/atom.xsd");
        dov.validate(in);

        SchemaFactory sf =
                SchemaFactory.newInstance(Constants.XML_XSD.uri);
        Schema schema = sf.newSchema(new File("repository/src/main/resources/xsd/atom.xsd"));
