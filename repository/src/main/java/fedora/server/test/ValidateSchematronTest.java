...
public class ValidateSchematronTest
    ...
    protected void setUp() {
        ...
        inSchematronPPFile = "repository/src/main/resources/schematron/preprocessor.xslt";

        // FOXML
        inFile = "TestIngestFiles/foxml-reference-ingest.xml";
        inSchematronRulesFile = "repository/src/main/resources/schematron/foxmlRules1-0.xml";
