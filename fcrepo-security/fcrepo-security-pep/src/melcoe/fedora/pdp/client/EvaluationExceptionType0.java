/**
 * EvaluationExceptionType0_Element.java
 *
...
public class EvaluationExceptionType0  extends org.apache.axis.AxisFault  implements java.io.Serializable {
     ...
     */
    public melcoe.fedora.pdp.client.EvaluationException getEvaluationException() {
        return evaluationException;
    }
     ...
     */
    public void setEvaluationException(melcoe.fedora.pdp.client.EvaluationException evaluationException) {
        this.evaluationException = evaluationException;
    }
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getEvaluationException() != null) {
            _hashCode += getEvaluationException().hashCode();
        }
