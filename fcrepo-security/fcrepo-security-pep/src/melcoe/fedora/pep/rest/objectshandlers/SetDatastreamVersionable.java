	    ...
	    throws IOException, ServletException
	{
		...
		try
		{
			...
			actions.put(Constants.ACTION.ID.getURI(), new StringAttribute(
			    Constants.ACTION.SET_DATASTREAM_VERSIONABLE.getURI().toASCIIString()));
			...
			LogUtil.statLog(request.getRemoteUser(), Constants.ACTION.SET_DATASTREAM_VERSIONABLE.getURI()
