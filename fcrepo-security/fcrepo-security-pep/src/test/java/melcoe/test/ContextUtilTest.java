...
public class ContextUtilTest
{
	public static void main(String[] args) throws Exception
	{
		...
		options.put("ServiceEndpoint", "http://localhost:8080/axis2/services/MelcoePDP");
	...
	private static List<Map<URI, AttributeValue>> getResources() throws URISyntaxException
	{
		...
		resAttr.put(Constants.OBJECT.PID.getURI(), new StringAttribute("demo:SmileyBeerGlass"));
	...
	private static Map<URI, AttributeValue> getActions() throws URISyntaxException
	{
		...
		actions.put(Constants.ACTION.ID.getURI(), new StringAttribute(Constants.ACTION.LIST_DATASTREAMS.getURI()
				.toASCIIString()));
		actions.put(new URI("urn:oasis:names:tc:xacml:1.0:action:action-id"), new StringAttribute(
				Constants.ACTION.ADD_DATASTREAM.getURI().toASCIIString()));
		return actions;
	}
