...
public class MelcoePDPLocator extends org.apache.axis.client.Service implements melcoe.fedora.pdp.client.MelcoePDP {
    ...
    public MelcoePDPLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for MelcoePDPSOAP11port_http
    private java.lang.String MelcoePDPSOAP11port_http_address = "http://localhost:8080/axis2/services/MelcoePDP";
    ...
    private java.lang.String MelcoePDPSOAP11port_httpWSDDServiceName = "MelcoePDPSOAP11port_http";
    ...
    public melcoe.fedora.pdp.client.MelcoePDPPortType getMelcoePDPSOAP11port_http(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            melcoe.fedora.pdp.client.MelcoePDPSOAP11BindingStub _stub = new melcoe.fedora.pdp.client.MelcoePDPSOAP11BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (melcoe.fedora.pdp.client.MelcoePDPPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                melcoe.fedora.pdp.client.MelcoePDPSOAP11BindingStub _stub = new melcoe.fedora.pdp.client.MelcoePDPSOAP11BindingStub(new java.net.URL(MelcoePDPSOAP11port_http_address), this);
                _stub.setPortName(getMelcoePDPSOAP11port_httpWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://pdp.xacml.melcoe/xsd", "MelcoePDP");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://pdp.xacml.melcoe/xsd", "MelcoePDPSOAP11port_http"));
        }
