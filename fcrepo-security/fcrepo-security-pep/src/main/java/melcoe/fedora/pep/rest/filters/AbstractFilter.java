...
public abstract class AbstractFilter implements RESTFilter
{
	 ...
	 * @throws PEPException
	 */
	public AbstractFilter() throws PEPException
	{
	 ...
	 */
	protected List<Map<URI, List<AttributeValue>>> getSubjects(HttpServletRequest request) throws ServletException
	{
		@SuppressWarnings("unchecked")
		Map<String, Set<String>> reqAttr = (Map<String, Set<String>>) request
	 ...
	 * 
	 * @param request the servlet request from which to obtain the attributes
