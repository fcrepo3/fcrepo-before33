...
public class ResponseCacheImpl implements ResponseCache
{
	 ...
	 * @param ttl maximum time for a cache item to be valid in milliseconds
	 * @throws PEPException
	 */
	...
	public void addCacheItem(String request, String response)
	{
		...
		try
		{
			...
			if (log.isDebugEnabled())
				log.debug("Adding Cache Item (" + requestCache.size() + "/" + requestCacheUsageTracker.size() + "/"
	...
	public String getCacheItem(String request)
	{
		...
		try
		{
			...
			if (log.isDebugEnabled())
				log.debug("Getting Cache Item (" + requestCache.size() + "/" + requestCacheUsageTracker.size() + "/"
						+ requestCacheTimeTracker.size() + "): " + hash);
