 ...
 * 
 */
public class PurgeObject extends AbstractFilter
{
	private static Logger log = Logger.getLogger(PurgeObject.class.getName());
	 ...
	 * @throws PEPException
	 */
	public PurgeObject() throws PEPException
	{
		super();
	}
	    ...
	    throws IOException, ServletException
	{
		...
		try
		{
			...
			actions.put(Constants.ACTION.ID.getURI(), new StringAttribute(Constants.ACTION.PURGE_OBJECT
			...
			LogUtil.statLog(request.getRemoteUser(), Constants.ACTION.PURGE_OBJECT.getURI().toASCIIString(),
			    pid, null);
		}
		catch (Exception e)
		{
