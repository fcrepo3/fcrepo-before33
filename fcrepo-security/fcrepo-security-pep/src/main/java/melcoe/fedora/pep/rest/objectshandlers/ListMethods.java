...
public class ListMethods extends AbstractFilter
{
	 ...
	 * @throws PEPException
	 */
	public ListMethods() throws PEPException
	{
		super();
	}
	    ...
	    throws IOException, ServletException
	{
		...
		try
		{
			...
			actions.put(Constants.ACTION.ID.getURI(), new StringAttribute(Constants.ACTION.LIST_METHODS
			...
			LogUtil.statLog(request.getRemoteUser(), Constants.ACTION.LIST_METHODS.getURI().toASCIIString(),
			    pid, null);
		}
		catch (Exception e)
		{
