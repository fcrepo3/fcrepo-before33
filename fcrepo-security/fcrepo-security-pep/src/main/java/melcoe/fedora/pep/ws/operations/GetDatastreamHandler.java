 ...
 *
 */
public class GetDatastreamHandler extends AbstractOperationHandler
{
	private static Logger log = Logger.getLogger(GetDatastreamHandler.class.getName());

	public GetDatastreamHandler() throws PEPException
	{
		super();
	}
	...
	{
		log.debug("GetDatastreamHandler/handleRequest!");
		...
		try
		{
			...
			LogUtil.statLog(context.getUsername(), Constants.ACTION.GET_DATASTREAM.getURI().toASCIIString(), pid, dsID);
		}
		catch (Exception e)
		{
