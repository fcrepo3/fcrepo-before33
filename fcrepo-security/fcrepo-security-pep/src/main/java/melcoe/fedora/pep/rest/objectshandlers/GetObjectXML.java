 ...
 * 
 */
public class GetObjectXML extends AbstractFilter
{
	private static Logger log = Logger.getLogger(GetObjectXML.class.getName());
	 ...
	 * @throws PEPException
	 */
	public GetObjectXML() throws PEPException
	{
		super();
	}
	    ...
	    throws IOException, ServletException
	{
		...
		try
		{
			...
			actions.put(Constants.ACTION.ID.getURI(), new StringAttribute(Constants.ACTION.GET_OBJECT_XML
			...
			LogUtil.statLog(request.getRemoteUser(), Constants.ACTION.GET_OBJECT_XML.getURI().toASCIIString(),
			    pid, null);
		}
		catch (Exception e)
		{
