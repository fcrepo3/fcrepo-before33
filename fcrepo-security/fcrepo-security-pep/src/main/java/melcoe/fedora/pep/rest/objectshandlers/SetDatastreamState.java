 ...
 * 
 */
public class SetDatastreamState extends AbstractFilter
{
	private static Logger log = Logger.getLogger(SetDatastreamState.class.getName());
	 ...
	 * @throws PEPException
	 */
	public SetDatastreamState() throws PEPException
	{
		super();
	}
	    ...
	    throws IOException, ServletException
	{
		...
		try
		{
			...
			actions.put(Constants.ACTION.ID.getURI(), new StringAttribute(
			    Constants.ACTION.SET_DATASTREAM_STATE.getURI().toASCIIString()));
			...
			LogUtil.statLog(request.getRemoteUser(), Constants.ACTION.SET_DATASTREAM_STATE.getURI()
