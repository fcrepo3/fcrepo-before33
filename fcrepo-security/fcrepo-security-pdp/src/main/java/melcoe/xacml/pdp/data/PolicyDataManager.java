...
public interface PolicyDataManager
{
	 ...
	 * 
	 * @param eval the Evaluation Context from which to match policies against
	 ...
	 * to the Policy Store.
	 * 
	 * @param f the policy as a {@link File}
	 * @param name the name to assign the policy
	 ...
	 * 
	 * @param document the policy as a {@link String}
	 * @param name
	 * @return the name of the added policy
	 * @throws {@link PolicyDataManagerException}
	 */
	 ...
	 * @param newDocument the new policy as a {@link String}
	...
	/**
	 * Searches through the policy store for policies that match the search criteria.
	 * Search criteria is passed in through the AttributeBean class. For a policy
	 * to match it has to contain all the attribute values in each of the
	 * AttributeBean elements.
	 * 
	 * @param attributes an array of AttributeBean classes
	 * @return map of policies keyed by the policies name and contain a byte array of the policy itself
	 * @throws PolicyDataManagerException
	 */
