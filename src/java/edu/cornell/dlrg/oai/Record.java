...
/**
 * Metadata expressed in a single format with a header and optional
 * "about" data which is descriptive of the metadata (such as
 * rights of provenance statements).
 * 
