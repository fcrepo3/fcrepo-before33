...
/**
 * Tests the METS deserializer and FOXML serializer by opening a METS file,
 * deserializing it, re-serializing it as FOXML, and sending it to STDOUT.
 * 
...
public class METSToFOXMLTest
    ...
    public void testDigitalObject() {
        ...
        assertNotNull("Failure: digital object audit record set is null.", obj
                .getAuditRecords());
        assertNotNull("Failure: digital object label is null.", obj.getLabel());
        assertNotNull("Failure: digital object ownerID is null.", obj
                .getOwnerId());
    }
}
