...
public class METSInOutTest
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            trans.serialize(obj, out, METS_EXT1_1.uri, "UTF-8", DOTranslationUtility.SERIALIZE_STORAGE_INTERNAL);
            System.out.println("Done.");
            if (args.length>1) {
                ...
                xmlSchemaMap.put(METS_EXT1_1.uri, "dist/server/xsd/mets-fedora-ext1-1.xsd");
				HashMap ruleSchemaMap = new HashMap();
				ruleSchemaMap.put(METS_EXT1_1.uri, "dist/server/schematron/metsExtRules1-0.xml");
                DOValidatorImpl v=new DOValidatorImpl(null, xmlSchemaMap,
                        "dist/server/schematron/preprocessor.xslt",
                        ruleSchemaMap);
                if (args[1].equals("1")) {
                    v.validate(newIn, METS_EXT1_1.uri,
