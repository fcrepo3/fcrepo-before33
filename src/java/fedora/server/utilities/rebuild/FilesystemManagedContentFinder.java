...
/**
 * Finds managed content in lowlevel storage. NOTE: Proper functionality hinges
 * on the following filename convention:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * From the baseDir provided in the constructor, the filesystem will be
 * traversed depth-first in alphanumeric order.
 */
