...
public class FilteredTripleIterator extends TripleIterator {
    ...
    public FilteredTripleIterator(TripleIterator baseIter, Triple filter,
    ...
    public FilteredTripleIterator(Map<String, String> aliasMap, Triple filter, boolean add)
    ...
    private boolean matches(Triple next, Triple filter) {
        ...
        return (partMatches(next.getSubject().toString(), filter.getSubject()
                ...
                && partMatches(next.getPredicate().toString(), filter
                        .getPredicate().toString()) && partMatches(next
                .getObject().toString(), filter.getObject().toString()));
