        ...
        if (dissemination != null)
        {
          try
          {
            ...
            fedora.server.types.gen.MIMETypedStream dissem =
                (fedora.server.types.gen.MIMETypedStream) call.invoke( new Object[] { PID, bDefPID, methodName, asOfDate} );
            response.setContentType(dissem.getMIMEType());
            /*BufferedReader br = new BufferedReader(
                new InputStreamReader(
                new ByteArrayInputStream(dissem.getStream())));
      ...
      } else if (action.equals(GET_BEHAVIOR_METHODS))
      {
        try
        {
          ...
          } else
          {
            ...
            if (debug) System.out.println("MIMEType: "+methodDefs.getMIMEType());
