...
/**
 * A <code>PIDGenerator</code> that produces ordered PIDs, and keeps track 
 * of where it's at using logfiles.
 * <p></p>
 * Implementation note: This is a wrapper around the PIDGeneration class
 * that casts it as a Module.
 *
