...
public class PIDGeneration implements PIDGenerator {
	...
	*/
        public PIDGeneration() throws ClassNotFoundException, FileNotFoundException, IOException {
		String lastPID;
		String tmpObjectID;
		int index;
		Properties props;
		...
		// Single threaded per class here.
			...
			if (lastObjectID == null) {
				...
				props.load(new BufferedInputStream(new FileInputStream("properties.txt")));
				logsDirectory = props.getProperty("logsDirectory", "logs");
