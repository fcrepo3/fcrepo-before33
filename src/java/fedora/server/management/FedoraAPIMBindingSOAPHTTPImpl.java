...
public class FedoraAPIMBindingSOAPHTTPImpl
            ...
            fedora.server.storage.types.RelationshipTuple[] intRelsTuples) 
    {
        ...
        {
            genRelsTuples[i] = TypeUtility.convertRelsTupleToGenRelsTuple(
                    intRelsTuples[i]);
        }
        ...
        throws java.rmi.RemoteException 
    {
        ...
        try {
            ...
            intRelationshipTuples = s_management.getRelationships(ReadOnlyContext.getSoapContext(), 
                                                 pid, subjectURI, relationship);
     ...
     public fedora.server.types.gen.RelationshipTuple addRelationship(String pid,
                                                                     String subjectURI,
                                                                     String relationship, 
                                                                     String objURI,
                                                                     String objLit,
        ...
        throws java.rmi.RemoteException
    {
        ...
        assertInitialized();
        try {
            fedora.server.storage.types.RelationshipTuple intRelationshipTuple;
            intRelationshipTuple = s_management.addRelationship(ReadOnlyContext.getSoapContext(), 
                                                 pid, subjectURI, relationship, objURI, objLit, litType);
            return TypeUtility.convertRelsTupleToGenRelsTuple(intRelationshipTuple);
        } catch (Throwable th) {
    ...
    public fedora.server.types.gen.RelationshipTuple purgeRelationship(String pid,
                                                                       String subjectURI, 
                                                                       String relationship, 
                                                                       String objURI,
                                                                       String objLit,
        ...
        throws java.rmi.RemoteException
    {
        ...
        try {
            fedora.server.storage.types.RelationshipTuple intRelationshipTuple;
            intRelationshipTuple = s_management.purgeRelationship(ReadOnlyContext.getSoapContext(), 
                                                 pid, subjectURI, relationship, objURI, objLit, litType);
            
            return TypeUtility.convertRelsTupleToGenRelsTuple(intRelationshipTuple);
        } catch (Throwable th) {
            LOG.error("Error purgeing relationships", th);
            throw AxisUtility.getFault(th);             
        } finally {
