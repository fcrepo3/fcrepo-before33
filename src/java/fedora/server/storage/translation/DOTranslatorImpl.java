...
/**
 * A threadsafe <code>DOTranslator</code> that uses a map of serializers
...
public class DOTranslatorImpl
    ...
    private Map<String, DOSerializer> m_serializers;
    
    /** The DODeserializer map, keyed by format string. */
    private Map<String, DODeserializer> m_deserializers;

    /**
     * Creates an instance.
     * 
     * @param serializers the DOSerializer map, keyed by format string.
     * @param deserializers the DODeserializer map, keyed by format string.
     */
