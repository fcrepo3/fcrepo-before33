...
/**
 * Interface for serializing and deserializing Fedora objects to/from
 * various formats.
 *
...
public interface DOTranslator {
     ...
     * @throws ObjectIntegrityException if the stream does not properly encode
     *         an object.
     * @throws StreamIOException if there is an error reading from the stream.
     * @throws ServerException if the translator is unable to deserialize for
     *         any other reason.
     * @throws UnsupportedEncodingException if the encoding is not supported
     *         by the JVM.
     * @see DOTranslationUtility#DESERIALIZE_INSTANCE
     */
    void deserialize(InputStream in, DigitalObject obj,
     ...
     * @param encoding the character encoding if the format is text-based.
     * @param transContext the translation context.
     * @throws ObjectIntegrityException if the given object is in such a state
     *         that serialization can't be performed.
     * @throws StreamIOException if there is an error writing to the stream.
     * @throws ServerException if the translator is unable to serialize for
     *         any other reason.
     * @throws UnsupportedEncodingException if the encoding is not supported
     *         by the JVM.
     ...
     */
    void serialize(DigitalObject obj, OutputStream out,
			String format, String encoding, int transContext)
            throws ObjectIntegrityException, StreamIOException,
            UnsupportedTranslationException, ServerException;
