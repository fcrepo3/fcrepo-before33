...
public interface ILowlevelStorage {
     ...
     *
     * @param key the $pid "+" $dsId "+" $dsVersionId string that uniquely
     ...
     */
    public void addDatastream(String key, InputStream content)
            throws LowlevelStorageException;
     ...
     */
    public void replaceDatastream(String key, InputStream content)
            throws LowlevelStorageException;
     ...
     */
    public InputStream retrieveDatastream(String key)
            throws LowlevelStorageException;
     ...
     */
    public void removeDatastream(String key) throws LowlevelStorageException;
