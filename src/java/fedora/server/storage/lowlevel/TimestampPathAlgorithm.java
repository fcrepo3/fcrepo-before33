...
class TimestampPathAlgorithm extends PathAlgorithm implements IPathAlgorithm {
	public TimestampPathAlgorithm () {
		super();
	}
	public String get (String pid, GregorianCalendar calendar) throws LowlevelStorageException {
		...
		return configuration.getStoreBase() + sep + year + sep + month + dayOfMonth + sep + hourOfDay + 
			sep + minute + sep + second + sep + pid + ".xml";
	}
