...
public interface BERoleConfig {
    ...
    /**
     * Get the list of IP addresses that are allowed to make back-end
     * callbacks to Fedora using this role.
     *
     * For BMech/MethodRoleConfig, null means the effective value is inherited.
     * For DefaultRoleConfig, null means no restriction.
     */
    public String[] getIPList();
    public String[] getEffectiveIPList();

    /**
     * Set the list of IP addresses that are allowed to make back-end
     * callbacks to Fedora using this role.
     *
     * For BMech/MethodRoleConfig, null means the effective value is inherited.
     * For DefaultRoleConfig, null means no restriction.
     ...
     *
     * For BMech/MethodRoleConfig, null means the effective value is inherited.
     * For DefaultRoleConfig, null means the effective value is false.
     */
     ...
     *
     * For BMech/MethodRoleConfig, null means the effective value is inherited.
     * For DefaultRoleConfig, null means unspecified.
     */
