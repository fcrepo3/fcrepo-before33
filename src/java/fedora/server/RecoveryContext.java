...
/**
 * A <code>Context</code> used for recovery.
 *
...
public interface RecoveryContext extends Context {
    ...
    /**
     * Get all values for a <em>recovery</em> attribute, or an empty array 
     * if no values exist for the attribute in this context.
     */
