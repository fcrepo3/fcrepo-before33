...
public interface OAIProvider {
     ...
     * @param metadataPrefix the metadata prefix identifier.
     ...
     * list.
     *
     * @param from the beginning date of the date range.
     * @param until the ending date of the date range.
     * @param metadataPrefix the metadata prefix.
     * @param set the set of criteria
     ...
     * of the list.
     *
     * @param resumptionToken a string that can be used to get the rest of the
     *                        list.
     ...
     * list.
     *
     * @param from the beginning date range.
     ...
     *
     * @param id The item identifier, or null, meaning "the entire repository"
