...
public class ServiceProfilePane
    ...
    public ServiceProfilePane(ServiceDeploymentBuilder parent) {
        ...
        String[] swtype =
                {ServiceSoftware.SW_APPLIC_SVR, ServiceSoftware.SW_APPLIC_CL,
                        ServiceSoftware.SW_APPLIC_UTIL, ServiceSoftware.SW_LIB,
                        ServiceSoftware.SW_SCRIPT, ServiceSoftware.SW_PROGRAM,
                        ServiceSoftware.SW_OS, ServiceSoftware.SW_PROGLANG,
        ...
        String[] license =
                {ServiceSoftware.L_COM, ServiceSoftware.L_GPL,
                        ServiceSoftware.L_LGPL, ServiceSoftware.L_MPL,
                        ServiceSoftware.L_BSD, ServiceSoftware.L_CPL,
                        ServiceSoftware.L_APACHE, ServiceSoftware.L_SUN,
                        ServiceSoftware.L_PUBLIC, ServiceSoftware.L_OTHER};
        ...
        String[] yesno =
                {Boolean.toString(ServiceSoftware.YES),
    ...
    public ServiceSoftware[] getSWDependencies() {
        ...
        for (int i = 0; i < rowcount; i++) {
            ...
            if (sw.swName != null && !sw.swName.equalsIgnoreCase("")
                ...
                sw.isOpenSource =
                        Boolean.parseBoolean((String) dependencyTable
                                .getValueAt(i, 4));
                elements.add(sw);
            }
        }
