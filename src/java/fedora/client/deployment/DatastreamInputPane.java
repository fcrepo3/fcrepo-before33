...
public class DatastreamInputPane
    ...
    public DatastreamInputPane(ServiceDeploymentBuilder parent) {
        ...
        JTextArea ta =
                new JTextArea("In the table below, define the "
                        + "data contract for this Service Definition. "
                        + "The data contract specifies what kinds of Datastreams must "
                        + "reside in a Fedora Data Object that uses this deployment. \n\n"
        ...
        String[] orderReq =
                (String[]) ordinalityTbl.keySet().toArray(new String[0]);
    ...
    //public void setDSBindingKeys()
    {
        ...
        if (keys.length > freeRows) {
            ...
            for (int j = 0; j < newRows; j++) {
                ((DefaultTableModel) dsinputTable.getModel())
    ...
    public DSInputRule[] getDSInputRules() {
        ...
        for (int i = 0; i < rowcount; i++) {
            ...
            dsRule.ordinality =
                    (String) ordinalityTbl.get(dsinputTable.getValueAt(i, 4));
