...
/**
 * Based on SimpleJDrawingCanvas.java
 */
...
public class SimpleJDrawingCanvas extends AbstractPaintable implements InputEventHandler, DrawingCanvas, ComponentHolder, PropertyChangeListener {
	 ...
	 */
	protected static final int buffer = 300;
	 ...
	 */
	public SimpleJDrawingCanvas(Drawing drawing) {
		super();
	...
	public void paint(Graphics g) {
        ...
        if (scrollPane!=null) {
            ...
            // System.out.println("viewrect=(" + viewRect.x + "," + viewRect.y + "," + viewRect.width + "," + viewRect.height + ")");
            g.setClip(viewRect);
        } else {
		    g.setClip( getBounds() );
        } 
	...
	protected void repaint() {
        // cwilper - only redraw the part visible
		component.repaint();
	}
	/** 
