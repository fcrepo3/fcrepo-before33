...
public class XMLBuilder {
    ...
    public String createObjectXML(OBJECT_TYPE objectType, String pid, String label) throws RemoteException {
        ...
        if(OBJECT_TYPE.contentModel.equals(objectType)) {
            ...
            xml.append("              $FEDORA_HOME/docs/userdocs/digitalobjects/objectModel.html#CMODEL.\n");
            ...
            xml.append("              $FEDORA_HOME/docs/userdocs/distribution/demos.html\n");
            xml.append("          </comment>\n");
            ...
            xml.append("              $FEDORA_HOME/docs/userdocs/digitalobjects/objectModel.html#SDEF.\n");
            ...
            xml.append("            $FEDORA_HOME/docs/userdocs/digitalobjects/objectModel.html#SDEP.\n");
