...
public class NewObjectDialog
   ...
   private boolean isContentModel;
       ...
       public NewObjectDialog(boolean isContentModel) {
               super(JOptionPane.getFrameForComponent(Administrator.getDesktop()),
                               (isContentModel ? "New Content Model": "New Object"), true);
               ...
               public void actionPerformed(ActionEvent evt) {
                       try {
                               ...
                               if (ok) {
                                       ...
                                       xml.append("    <foxml:property NAME=\"" + RDF.TYPE.uri + "\" VALUE=\""+(isContentModel ? "FedoraCModelObject" : "FedoraObject") +"\"/>\n");
