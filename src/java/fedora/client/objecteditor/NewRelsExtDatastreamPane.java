...
class NewRelsExtDatastreamPane extends DatastreamPane {
    ...
    public NewRelsExtDatastreamPane(ObjectEditorFrame gramps, String pid, DatastreamsPane owner) throws Exception
    {
        ...
        m_currentVersionPane.m_actionPane.remove(m_currentVersionPane.m_exportButton);
        m_currentVersionPane.m_actionPane.remove(m_currentVersionPane.m_purgeButton);
    ...
    private static Datastream[] MakeBlankRelsExtDatastream()
    {
        ...
        ds[0] = new Datastream(DatastreamControlGroup.fromValue("X"), s_dsid, "RELS-EXT.0", null,
                               "Relationships to other objects", true, "text/xml", null, null, 0, "A",
                               null, null, null);
        return ds;
    }
    ...
    public void saveChanges(String logMessage) throws Exception 
    {
        ...
        { 
            ...
            try {
                ...
                String label = m_currentVersionPane.m_labelTextField.getText().trim();
                String mimeType = m_currentVersionPane.m_MIMETextField.getText().trim();
                String formatURI = m_currentVersionPane.m_formatURITextField.getText().trim();
                String[] altIDs = m_currentVersionPane.m_altIDsTextField.getText().trim().split(" ");
                String checksumType = m_currentVersionPane.m_checksumTypeComboBox.getSelectedItem().toString();
                if (checksumType.equals("Default"))  checksumType = null;
                String location = null;
                location = Administrator.UPLOADER.upload(m_currentVersionPane.m_editor.getContent());
