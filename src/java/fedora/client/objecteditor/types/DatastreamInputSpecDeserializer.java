...
class DatastreamInputSpecDeserializer
    ...
    public void endElement(String uri, 
                           ...
                           String qName) 
            throws SAXException {
        if (localName.equals("DSInputLabel")
                || localName.equals("DSMIME")
            ...
            try {
                ...
                if ((m_max!=null) && (m_max.startsWith("-") 
                        || m_max.startsWith("n")
                        || m_max.startsWith("N")
                        || m_max.startsWith("u")
                        || m_max.startsWith("U")
            ...
            m_bindingRules.add(
                    new DatastreamBindingRule(m_key,
                                              m_inputLabel.toString(),
                                              m_inputInstruction.toString(),
                                              min,
                                              max,
                                              orderMatters,
                                              types));
