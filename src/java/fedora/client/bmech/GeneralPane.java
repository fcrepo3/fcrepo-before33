...
public class GeneralPane extends JPanel {
	...
	private JPanel setDescriptionPanel() {
		...
		descriptionPanel.setBorder(new TitledBorder(
				"Behavior Mechanism Description"));
		...
		gbc.gridx = 0;
		descriptionPanel
				.add(new JLabel("Behavior Object Name (1 word): "), gbc);
		gbc.gridx = 1;
	...
	private JPanel setContractPanel() {
		...
		contractPanel
				.setBorder(new TitledBorder("Behavior Definition Contract"));
		GridBagConstraints gbc2 = new GridBagConstraints();
		// gbc2.anchor = GridBagConstraints.WEST;
		gbc2.gridy = 0;
		gbc2.gridx = 0;
		contractPanel.add(new JLabel("Behavior: "), gbc2);
		...
		bDefPIDComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				try {
					String[] parts = ((String) bDefPIDComboBox
				...
				if (bDefPID != null) {
					MethodsPane mp = (MethodsPane) ((BMechBuilder) parent).tabpane
							.getComponentAt(2);
	...
	private void editDCElement() {
		...
		int currentRowIndex = dcTable.getSelectedRow();
		dcDialog = new DCElementDialog(this, "Edit DC Element", true,
	...
	protected void assertInvalidDCMsg(String msg) {
		JOptionPane.showMessageDialog(this, new String(msg),
				"Invalid DC Element", JOptionPane.INFORMATION_MESSAGE);
	}
