...
import fedora.client.bmech.xml.BMechMETSSerializer;
import fedora.client.bmech.xml.DCGenerator;
import fedora.client.bmech.xml.DSInputSpecGenerator;
import fedora.client.bmech.xml.MethodMapGenerator;
import fedora.client.bmech.xml.ServiceProfileSerializer;
import fedora.client.bmech.xml.WSDLGenerator;
...
public class BMechBuilder
    ...
    public static void main(String[] args) {
        try {
            if (args.length == 5) {
                ...
                frame.getContentPane().add(new BMechBuilder(protocol,
                                                            host,
                                                            port,
                                                            user,
                                                            pass,
    ...
    public BMechBuilder(String protocol,
                        String host,
                        int port,
                        String user,
                        String pass,
        ...
        if (mets != null) {
            ...
            if (chooser.showSaveDialog(tabpane) == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    assertTabPaneMsg(("BMechBuilder: Error saving METS file for bmech: " + e
                                             .getMessage()),
                                     "BMechBuilder");
                }
            } else {
    ...
    public void ingestBMech() {
        ...
        if (mets != null) {
            try {
                ...
                e.printStackTrace();
                assertTabPaneMsg(("BMechBuilder: Error saving METS to stream for bmech: " + e
                                         .getMessage()),
                                 "BMechBuilder");
            }
            try {
                ...
                e.printStackTrace();
                assertTabPaneMsg(("BMechBuilder: error ingesting bmech object: " + e
                                         .getMessage()),
                                 null);
            }
    ...
    public BMechMETSSerializer savePanelInfo() {
        ...
        if (validateBMechTemplate()) {
            ...
            try {
                ...
                e.printStackTrace();
                assertTabPaneMsg("BMechBuilder: error serializing service profile",
                                 null);
            }
            try {
                ...
                e.printStackTrace();
                assertTabPaneMsg("BMechBuilder: error serializing ds input spec",
                                 null);
            }
            try {
            ...
            try {
                mets =
                        new BMechMETSSerializer(newBMech,
                                                dcg.getRootElement(),
                                                spg.getRootElement(),
                                                dsg.getRootElement(),
                                                mmg.getRootElement(),
                ...
                e.printStackTrace();
                assertTabPaneMsg("BMechBuilder: error in creating METS for bmech.",
                                 null);
            }
            // mets.printMETS();
            // return mets;
    ...
    private boolean validGeneralTab(GeneralPane gp) {
        if (gp.rb_chosen.equalsIgnoreCase("retainPID")
            ...
            assertTabPaneMsg("Behavior Object Description is missing on General Tab.",
                             gp.getName());
            return false;
        } else if (gp.getBObjectName() == null
                || gp.getBObjectName().trim().equals("")) {
            assertTabPaneMsg("Behavior Object Name (1-word) is missing on General Tab.",
                             gp.getName());
            return false;
