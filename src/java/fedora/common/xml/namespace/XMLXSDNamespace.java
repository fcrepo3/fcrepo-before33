 ...
 * </pre>
 *
 * <p><em><b>NOTE:</b> This is subtly different from the RDF XSD namespace, in
 * that its URI does not end with a <code>#</code>.</em>  See
...
public class XMLXSDNamespace
    ...
    private static final XMLXSDNamespace ONLY_INSTANCE
            = new XMLXSDNamespace();
