...
(exec $JAVA_HOME/bin/java -Xms64m -Xmx96m -cp $FEDORA_HOME/mckoi094/gnu-regexp-1.1.4.jar -jar $FEDORA_HOME/mckoi094/mckoidb.jar -conf $FEDORA_HOME/mckoi094/db.conf &)
