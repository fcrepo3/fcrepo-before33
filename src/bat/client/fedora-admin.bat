...
:runMinimized
"%JAVA_HOME%\bin\java" -Xms64m -Xmx96m -cp %FEDORA_HOME%\client -Dfedora.home=%FEDORA_HOME% -Djavax.xml.parsers.DocumentBuilderFactory=org.apache.xerces.jaxp.DocumentBuilderFactoryImpl -Djavax.xml.parsers.SAXParserFactory=org.apache.xerces.jaxp.SAXParserFactoryImpl -Daxis.socketSecureFactory="org.apache.axis.components.net.SunFakeTrustSocketFactory" -jar %FEDORA_HOME%\client\client.jar %1 %2 %3 %4 %5
