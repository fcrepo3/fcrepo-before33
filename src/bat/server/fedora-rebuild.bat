...
"%JAVA_HOME%\bin\java" -server -Xmn64m -Xms256m -Xmx256m -cp %TC%\webapps\fedora\WEB-INF\classes -Dfedora.home=%FEDORA_HOME% -Djavax.xml.parsers.DocumentBuilderFactory=org.apache.xerces.jaxp.DocumentBuilderFactoryImpl -Djavax.xml.parsers.SAXParserFactory=org.apache.xerces.jaxp.SAXParserFactoryImpl -Djava.endorsed.dirs=%TC%\common\endorsed;%TC%\webapps\fedora\WEB-INF\lib;%TC%\common\lib -Djava.io.tmpdir=%TC%\temp fedora.server.utilities.rebuild.Rebuild %1
