...
public class ResourceIndexAddDelDissIntegrationTest 
     ...
     * Construct the test.
     */
    public ResourceIndexAddDelDissIntegrationTest(String name) {
        super(name);
    }
    ...
    /**
     * Add, then delete an object with one datastream used by one disseminator
     * with a one-parameter method with two possible values.
     */
    ...
    /**
     * Add, then delete an object with one datastream used by one disseminator
     * with a one-parameter method with any possible value.
     */
