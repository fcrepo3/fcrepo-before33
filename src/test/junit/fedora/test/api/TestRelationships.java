 ...
 * 
 * Tests assume a running instance of the Fedora server with Resource Index enabled.
 * 
 * @author Edwin Shin
 * @version $Id$
 *
...
public class TestRelationships
    ...
    public void testPurgeRelationships() throws Exception {
        ...
        assertFalse("Purging non-existant relation should have failed", 
                apim.purgeRelationship(pid, "urn:asdf", "867-5309", true, null));
    }
    
    private void addRelationship(String pid, String predicate, 
            String object, boolean isLiteral, String datatype) throws Exception {        
        assertTrue(apim.addRelationship(pid, predicate, object, isLiteral, datatype));        
        assertFalse("Adding duplicate relationship should return false", apim.addRelationship(pid, predicate, object, isLiteral, datatype));
    ...
    private void getRelationship(String pid, String predicate, 
            String object, boolean isLiteral, String datatype) throws Exception {
    ...
    private void purgeRelationship(String pid, String predicate, 
            String object, boolean isLiteral, String datatype) throws Exception {
        addRelationship(pid, predicate, object, isLiteral, datatype);
        assertTrue(apim.purgeRelationship(pid, predicate, object, isLiteral, datatype));
    }
