...
public class TestAPIM extends FedoraServerTestCase {
    ...
    public void testDatastreamMethods() throws Exception {
        ...
        try
        {
            String datastreamId = apim.addDatastream("demo:14", "NEWDS1", null, "A New M-type Datastream", true, "text/xml", "info:myFormatURI/Mtype/stuff#junk", "http://fedora.info/definitions/1/0/foxml1-1.xsd", "M", "A", "MD6", null, "adding new datastream");
        ...
        try
        {
            String datastreamId = apim.addDatastream("demo:14", "NEWDS1", null, "A New M-type Datastream", true, "text/xml", "info:myFormatURI/Mtype/stuff#junk", "http://fedora.info/definitions/1/0/foxml1-1.xsd", "M", "A", "TIGER", null, "adding new datastream");
            // fail if datastream was added
            fail();
        }
        catch (AxisFault af)
        ...
        String datastreamId = apim.addDatastream("demo:14", "NEWDS1", altIds, "A New M-type Datastream", true, "text/xml", "info:myFormatURI/Mtype/stuff#junk", "http://fedora.info/definitions/1/0/foxml1-1.xsd", "M", "A", null, null, "adding new datastream");
        ...
        datastreamId = apim.addDatastream("demo:14", "NEWDS2", altIds, "A New X-type Datastream", true, "text/xml", "info:myFormatURI/Xtype/stuff#junk", "http://fedora.info/definitions/1/0/foxml1-1.xsd", "X", "A", null, null, "adding new datastream");
        ...
        datastreamId = apim.addDatastream("demo:14", "NEWDS3", altIds, "A New E-type Datastream", true, "text/xml", "info:myFormatURI/Etype/stuff#junk", "http://fedora.info/definitions/1/0/foxml1-1.xsd", "E", "A", null, null, "adding new datastream");
        ...
        datastreamId = apim.modifyDatastreamByReference("demo:14", "NEWDS1", altIds, "Modified M-type Datastream", "text/xml", "info:newMyFormatURI/Mtype/stuff#junk", "http://fedora.info/definitions/1/0/foxml1-1.xsd", null, null, "modified datastream", false);
