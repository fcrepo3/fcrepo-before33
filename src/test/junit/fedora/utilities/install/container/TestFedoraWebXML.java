...
public class TestFedoraWebXML {
    ...
    public void testOptions() throws Exception {
        ...
        // TestConfigA
        webXML = new FedoraWebXML(webXMLFilePath, 
                getOptions(false, true, true, false, ""));
        assertNotNull(webXML);
        
        // TestConfigB
        webXML = new FedoraWebXML(webXMLFilePath, 
                getOptions(true, true, true, false, ""));
        
        // rest enabled
        webXML = new FedoraWebXML(webXMLFilePath, 
                getOptions(true, true, true, true, ""));
        
    }
    
    private WebXMLOptions getOptions(boolean apiaA, boolean apiaS, boolean apimS, boolean rest, String fedoraHome) {
