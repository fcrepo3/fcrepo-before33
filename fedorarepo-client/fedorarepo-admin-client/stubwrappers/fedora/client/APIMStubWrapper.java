...
// call wrapped method
    ...
    public java.lang.String createNew(java.lang.String logMessage, java.lang.String newPid) throws java.rmi.RemoteException {
        String METHOD_NAME = "createNew";
        HashMap PARMS = new HashMap();
        PARMS.put("logMessage", logMessage);
        PARMS.put("newPid", newPid);
        // Run the method in a SwingWorker thread
        SwingWorker worker = new SwingWorker(PARMS) {
            public Object construct() {
                try {
...
// call wrapped method
                    return m_instance.createNew((java.lang.String) parms.get("logMessage"), (java.lang.String) parms.get("newPid"));
