...
mvn install:install-file -Dfile=lib/jakarta-oro-2.0.5.jar -DgroupId=org.fedorarepo -DartifactId=jakarta-oro -Dversion=2.0.5 -Dpackaging=jar -DgeneratePom=true
...
mvn install:install-file -Dfile=lib/mptstore-0.9.1.jar -DgroupId=org.fedorarepo -DartifactId=mptstore -Dversion=0.9.1 -Dpackaging=jar -DgeneratePom=true
...
mvn install:install-file -Dfile=lib/openrdf-sesame-2.2.1-onejar.jar -DgroupId=org.fedorarepo -DartifactId=openrdf-sesame-onejar -Dversion=2.2.1 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=lib/saxon9-dom.jar -DgroupId=org.fedorarepo -DartifactId=saxon-dom -Dversion=9.0 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=lib/saxon9.jar -DgroupId=org.fedorarepo -DartifactId=saxon -Dversion=9.0 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=lib/sunxacml-patched.jar -DgroupId=org.fedorarepo -DartifactId=sunxacml -Dversion=1.2-PATCHED -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=lib/Tidy.jar -DgroupId=org.fedorarepo -DartifactId=Tidy -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true
...
mvn install:install-file -Dfile=lib/tt-bytecode.jar -DgroupId=org.fedorarepo -DartifactId=tt-bytecode -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true
