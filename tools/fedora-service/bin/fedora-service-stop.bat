...
echo Stopping Windows Service version of Fedora server...
...
echo Server is stopping, please wait.....
...
if "%VALUE%" == "3" goto waitStopped
if "%VALUE%" == "4" goto didntStop
if "%VALUE%" == "1" goto stopped

:didntStop
echo Fedora server failed to stop, check logs\fedora-service.log for details
goto finish

:stopped
echo Fedora server now stopped.
goto finish
